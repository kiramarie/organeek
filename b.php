                                                    ...
                                                    <div class="blog-post">
                                                            ...
                                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                                    ...
                                                                    <div class="blog-image">
                                                                        <h3> <a href="blog-single.php?id=<?php echo $a['recipe_id']; ?>"><?php echo $a['title'] ?></a></h3>
                                                                    </div>        
                                                                    <!-- Paragraph -->
                                ...
                                <!-- Search Sidebar Start-->
                                        ...
                                        <div class=" blog-post-details-item-right">
                                            <ul class="nav nav-list primary">
                                                <li>
                                                    <a href="#"> <i class="fa fa-angle-double-right">&nbsp; &nbsp; Body & Skin Care </i> </a>
                                                </li>
                                                <li>
                                                    <a href="#"> <i class="fa fa-angle-double-right">&nbsp; &nbsp; Face Care </i> </a>
                                                </li>
                                                <li>
                                                    <a href="#"> <i class="fa fa-angle-double-right">&nbsp; &nbsp; Hair </i> </a>
                                                </li>
                                                <li>
                                                    <a href="#"> <i class="fa fa-angle-double-right">&nbsp; &nbsp; Eye Care </i> </a>
                                                </li>
                                                <li>
                                                    <a href="#"> <i class="fa fa-angle-double-right">&nbsp; &nbsp; Hand and Feet</i> </a>
                                                </li>
                                                <li>
                                                    <a href="#"> <i class="fa fa-angle-double-right">&nbsp; &nbsp; Natural Home </i> </a>
                                                </li>
