    ...
    && in_array($extension, $allowedExts)) {
        if ($_FILES["photo"]["error"] > 0) {
            ...
            $recipe->title = mysql_escape_string($_POST['title']);
                ...
                //$recipe->recipeEdit(mysql_escape_string($_POST['recipe_id']));
        } else {
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category">
                                                <option value="<?php echo $recipe->category ?>"><?php echo $recipe->category ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sub_category">
                                                <option value="<?php echo $recipe->sub_category ?>"><?php echo $recipe->sub_category ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sub_category2">
                                                <option value="<?php echo $recipe->sub_category2 ?>"><?php echo $recipe->sub_category2 ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="title" value="<?php echo $recipe->title ?>">
                                        </div>
                                        <div class="form-group">
