                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $a['recipe_id'] ?></td>
                                                <td><?php echo $a['title'] ?></td>
                                                <td><?php echo $a['created'] ?></td>
                                                <td><?php echo $a['status'] ?></td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-success" href="edit.php?id=<?php echo $a['recipe_id'] ?>">Edit</a>
                                                        <a class="btn btn-success" href="view.php?id=<?php echo $a['recipe_id'] ?>">View</a>
                                                        <a class="btn btn-success" href="delete.php?id=<?php echo $a['recipe_id'] ?>">Delete</a>
                                                        <?php
                                                        if($a['status']==1){
                                                        ?>
                                                        <a class="btn btn-success" href="deactivate.php?id=<?php echo $a['recipe_id'] ?>">Deactivate</a>
                                                        <?php }else{ ?>
                                                        <a class="btn btn-success" href="activate.php?id=<?php echo $a['recipe_id'] ?>">Activate</a>
                                                        <?php } ?>
                                                    </div>
                                                </td>
                                            </tr>
